...
package app_screens {
	...
	public class Screen23 extends Sprite{

	    public var layout:Sprite;
        public var _bg:Image;
        public var _product:LayoutGroup;
        ...
        private function drawScreen():void
        {
	        ...
	        if(Khun_T12.ipadProDisplay == "pro"){
		        layout = Root.uiBuilder.create(ParsedLayouts.screen23_layout_pro, false, this) as Sprite;
	        }
	        else{
		        layout = Root.uiBuilder.create(ParsedLayouts.screen23_layout, false, this) as Sprite;
	        }
	        addChild(layout);
