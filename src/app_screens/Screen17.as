...
package app_screens {
	...
	public class Screen17 extends Sprite{
        ...
        private function drawScreen():void
        {
	        ...
	        if(Khun_T12.ipadProDisplay == "pro"){
		        layout = Root.uiBuilder.create(ParsedLayouts.screen17_layout_pro, false, this) as Sprite;
	        }
	        else{
		        layout = Root.uiBuilder.create(ParsedLayouts.screen17_layout, false, this) as Sprite;
	        }
	        addChild(layout);
					...
					setTimeout(function():void {
						if(Root.touchStatus == "touch") {
							if (product == _product_img1) {
								display3D("Toilet", false, 5);
							}
							else if (product == _product_img2) {
								display3D("WashBasin", true, 2);
							}
						}
					}, 100);
				}
