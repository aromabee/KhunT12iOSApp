package app_screens {
    ...
    public class Section2 extends Sprite {


        public var screenContainer:Sprite3D;

        public var screen3:Screen3;
        public var screen4:Screen4;
        public var screen5:Screen5;
        public var screen6:Screen6;
        public var screen7:Screen7;
        public var screen8:Screen8;
        public var screen9:Screen9;
        ...
        private function drawScreen():void
        {
            ...
            screen3 = new Screen3();
            screen3.initialize(sAssets);
	        screenContainer.addChild(screen3);
	        screenArray.push(screen3);

            screen4 = new Screen4();
            screen4.initialize(sAssets);
            screenContainer.addChild(screen4);
            screenArray.push(screen4);

            screen5 = new Screen5();
            screen5.initialize(sAssets);
            screenContainer.addChild(screen5);
            screenArray.push(screen5);

            screen6 = new Screen6();
            screen6.initialize(sAssets);
            screenContainer.addChild(screen6);
            screenArray.push(screen6);

            screen7 = new Screen7();
            screen7.initialize(sAssets);
            screenContainer.addChild(screen7);
            screenArray.push(screen7);

            screen8 = new Screen8();
            screen8.initialize(sAssets);
            screenContainer.addChild(screen8);
            screenArray.push(screen8);

            screen9 = new Screen9();
            screen9.initialize(sAssets);
            screenContainer.addChild(screen9);
            screenArray.push(screen9);
