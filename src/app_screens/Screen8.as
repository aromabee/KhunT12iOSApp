...
package app_screens {
	...
	public class Screen8 extends Sprite{

	    public var layout:Sprite;
        public var _bg:Image;
        public var _images:LayoutGroup;
        ...
        private function drawScreen():void
        {
	        ...
	        if(Khun_T12.ipadProDisplay == "pro"){
		        layout = Root.uiBuilder.create(ParsedLayouts.screen8_layout_pro, false, this) as Sprite;
	        }
	        else{
		        layout = Root.uiBuilder.create(ParsedLayouts.screen8_layout, false, this) as Sprite;
	        }
	        addChild(layout);
