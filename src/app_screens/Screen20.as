	...
	public class Screen20 extends Sprite{
        ...
        private function drawScreen():void
        {
	        ...
	        if(Khun_T12.ipadProDisplay == "pro"){
		        layout = Root.uiBuilder.create(ParsedLayouts.screen20_layout_pro, false, this) as Sprite;
	        }
	        else{
		        layout = Root.uiBuilder.create(ParsedLayouts.screen20_layout, false, this) as Sprite;
	        }
	        addChild(layout);
					...
					setTimeout(function():void {
						if(Root.touchStatus == "touch") {
							if (product == _product_img1) {
								display3D("ShowerHead", false);
							}
							else if (product == _product_img2) {
								display3D("HandShower", true, 3);
							}
						}
					}, 100);
				}
