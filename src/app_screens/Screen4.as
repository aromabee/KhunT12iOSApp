	...
	public class Screen4 extends Sprite{
        ...
        private function drawScreen():void {
	        ...
	        if(Khun_T12.ipadProDisplay == "pro"){
		        layout = Root.uiBuilder.create(ParsedLayouts.screen4_layout_pro, false, this) as Sprite;
	        }
	        else{
		        layout = Root.uiBuilder.create(ParsedLayouts.screen4_layout, false, this) as Sprite;
	        }
	        addChild(layout);
